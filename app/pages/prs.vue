<template>
  <div class="flex flex-1 flex-col gap-8">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <div v-for="pr in data?.prs" :key="pr.created_at" class="pr group">
        ...
        <div class="flex flex-col gap-1 text-sm text-end">
          <p class="group-hover:text-amber-500">
            <span>
    ...
    <p class="text-center">
      <span>Credit to </span>
      <NuxtLink to="https://github.com/atinux" target="_blank"
        >@atinux</NuxtLink
      >
...
defineOgImage('Default', {
  title: 'OpenSource',
  description: 'My humble contributions in the opensource community.'
})

useSeoMeta({
  ogTitle: 'OpenSource',
  ogDescription: 'My humble contributions in the opensource community.',
  description: 'My humble contributions in the opensource community.'
})
